...
**B4A** is a simple to use and powerful **RAD (Rapid Application Development)** from Anywhere Software, capable of building completely native **Android** applications. 
...
Combined with **B4i** (which is another **RAD** tool from Anywhere Software) you can share most of the logic code between **And**roid and **iOS** projects.
